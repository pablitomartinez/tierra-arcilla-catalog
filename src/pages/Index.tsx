    ...
    <PublicLayout>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container relative py-24 md:py-40 lg:py-52">
          <div className="max-w-2xl space-y-6">
            ...
            <p className="text-lg md:text-xl text-primary-foreground/90 font-body leading-relaxed animate-fade-in" style={{ animationDelay: "0.15s" }}>
              {brand.description}
            </p>
            <div className="animate-fade-in" style={{ animationDelay: "0.3s" }}>
              <Button asChild size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground gap-2 font-body font-semibold">
                <Link to="/productos">Ver catálogo<ArrowRight className="h-4 w-4" /></Link>
              </Button>
            </div>
          </div>
        </div>
      ...
      <section className="bg-secondary py-16 md:py-24">
        <div className="container max-w-3xl text-center space-y-6">
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-secondary-foreground">Hecho a Mano, Hecho con Alma</h2>
