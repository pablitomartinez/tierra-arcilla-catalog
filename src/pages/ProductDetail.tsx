    ...
    return (
      <PublicLayout>
        <div className="container py-20 text-center">
          <h1 className="font-heading text-2xl font-bold text-foreground mb-4">Producto no encontrado</h1>
  ...
  return (
    <PublicLayout>
      <article className="container py-8 md:py-16">
        <Link to="/productos" className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground transition-colors mb-6">
